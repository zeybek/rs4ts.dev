...
import { pluginRustPlayground } from "./src/lib/ec-rust-playground.mjs";
...
export default {
  ...
  // `playground` flag on a ```rust fence adds an inline "Run" button (executes on
  // play.rust-lang.org). See src/lib/ec-rust-playground.mjs.
  plugins: [pluginCollapsibleSections(), pluginLineNumbers(), pluginRustPlayground()],
  defaultProps: {
