...
You will also need the repository's [pinned Rust verification toolchain](/00-introduction/05-version-policy/)
and the Rust 2024 edition used by this project.
