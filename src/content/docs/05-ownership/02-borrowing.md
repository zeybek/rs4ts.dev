...
> **Note:** This guide targets the repository's [pinned verification toolchain](/00-introduction/05-version-policy/) and the 2024 edition; `cargo new` selects that edition automatically. The pin is a reproducible baseline, not a moving “latest stable” claim.
