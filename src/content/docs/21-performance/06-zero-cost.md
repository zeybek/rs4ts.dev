...
Claims about "zero cost" are worthless without proof, so here is the proof, generated on a real Rust 1.96.0 toolchain (the recorded verification toolchain, 2024 edition, which `cargo new` selects automatically).
