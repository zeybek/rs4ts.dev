...
> **Tip:** The current stable toolchain is Rust 1.96.0 on the 2024 edition; `cargo new` selects it automatically. Atomics and `Ordering` have been stable since Rust 1.0 and follow the C++20 memory model.
