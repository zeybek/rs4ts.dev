...
Here is that same JSON API in each of the four frameworks, so you can compare the handler ergonomics side by side. Every snippet below is compile-verified against the current crate versions (axum 0.8.9, actix-web 4.13.0, rocket 0.5.1, poem 3.1.12) on Rust 1.96.0, the latest stable edition (2024).
