...
First add the crate to a 2024-edition project created with `cargo new`; this guide checks it with the repository's [pinned verification toolchain](/00-introduction/05-version-policy/):
