...
> **Note:** The latest stable Rust is **1.96.0** and the latest stable edition is **2024** (selected automatically by `cargo new`). These examples need Tokio: `cargo add tokio --features full`. See [Setting Up Tokio](/11-async/03-tokio-setup/).
