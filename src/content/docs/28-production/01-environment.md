...
Add the dependencies in a fresh 2024-edition project; the repository's [pinned verification toolchain](/00-introduction/05-version-policy/) provides the reproducible compiler baseline:
