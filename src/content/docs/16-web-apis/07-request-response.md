...
The repository's [pinned verification toolchain](/00-introduction/05-version-policy/) uses the 2024 edition; `cargo new` selects that edition automatically. This page targets **axum 0.8** (0.8.9), started with `axum::serve` and a `tokio::net::TcpListener`.
