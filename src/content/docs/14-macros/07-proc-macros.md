...
> **Note:** The repository's [pinned verification toolchain](/00-introduction/05-version-policy/) uses the 2024 edition; `cargo new` selects the newest edition automatically. Every Rust snippet here was compiled and run on stable with `syn` 2.0.117, `quote` 1.0.45, and `proc-macro2` 1.0.106.
