...
> **Note:** The repository's [pinned verification toolchain](/00-introduction/05-version-policy/) uses the **2024 edition**. Create projects with `cargo new` (it auto-selects the newest edition) and never pin an older one. Everything in this file is verified on a 2024-edition project.
