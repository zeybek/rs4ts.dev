...
> **Note:** The repository's [pinned verification toolchain](/00-introduction/05-version-policy/) uses the 2024 edition; `cargo new` selects the newest edition automatically. The examples here use `serde` 1.x (with the `derive` feature) and `serde_json` 1.x.
